...
export default function Examples() {
  return (
    ...
    <h2>¡La gente enamorada del CM de Malvinas en AGS!</h2>
    <p>Se comenta que se hacía fila para pedirle una foto. Eos atque impedit vel vitae illum et totam quis sed enim magni. Aut consequatur voluptate id repudiandae eaque ut voluptas repellat ut adipisci iste ut officia fugit!
    </p>
    ...
    <img
                ...
                />
                <hr className="line-primary" />
    <h2>¡Campeones del Six Invitational 2022!</h2>
    ...
    <img
                ...
                />
                <hr className="line-primary" />
    <h2>¡Campeones de la M4!</h2>
    <p>Ea distinctio ipsum rem omnis sint et unde ipsa ut minima labore aut rerum dignissimos ut ipsa nihil aut magnam dignissimos. Ut sint omnis et amet repudiandae qui repellendus architecto ut neque ipsa. Ut odio culpa At voluptatem voluptatem aut galisum assumenda aut expedita culpa vel velit quibusdam.
